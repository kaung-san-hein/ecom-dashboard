...
export const productFormSchema = z.object({
  ...
  discountPercentage: z.number().min(0, { message: 'Discount percentage must be greater than or equal to 0.' }).max(100, { message: 'Discount percentage must be less than or equal to 100.' }).optional(),
